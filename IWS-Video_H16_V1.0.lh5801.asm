...
;------------------------------------------------------------------------------
; UNKNOWN
JMP_819E: ; BR $826F, $827C, LIST:$8F8F
    PSH  Y
...
;------------------------------------------------------------------------------
; UNKNOWN
JMP_8963: ; BR $8241,$84CD,$866A,$8671,$8678,$8A98
    PSH  A
    LDI  A,$0A
    STA  #(CRTCTRL) ; &7800
    LDI  A,$20
...
JMP_8E5F:
    LDI  YH,$70 ; video RAM or shadow RAM?
    LDI  YL,$00
    RTN
...
JMP_906A:
    ...
    LDI  XL,$00
    LDI  UH,$07 ; IWS $7802~$7FFF not used?
    LDI  UL,$D0
...
BR_90B3:
    LDI  S,(CPU_STACK + $4F)
    SJP  ($CFCC) ; ***Init Sys Addr, turn off trace
    SJP  ($D02B) ; ***Clear IN_BUF w/$0D
    LDI  A,$3E
    STA  (Y)
    ANI  (BREAKPARAM),$EF
    ANI  (DISP_BUFF + $4E),$FE
...
JMP_9189:
    LDI  XH,$77 ; IWS Video RAM?
    LDI  XL,$7F
    LDI  YH,$77 ; IWS Video RAM?
    LDI  YL,$CF
    LDI  UH,$07
    LDI  UL,$80
...
BR_92C8:
    ...
    CPI  UH,$44
    BZR  BR_92D4 ; $92D4
    JMP  $A8E8 ; ***CE150 MTRDRV $A8DD

BR_92D4:
    ;BCH  JMP_92D6 ; $92D6
    .BYTE $9E,$00 ; assm calc wrong dir on 0 len
